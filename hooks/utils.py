...
def check_and_update_shown(session_id, prefix, warning_key, log_file=None):
    """
    Check if a warning key has already been shown.
    If not, add it to the state and return True (meaning it should be shown).
